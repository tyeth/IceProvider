...
private int currentProgressTotal = 0;
        ...
        private List<string> IgnoreHostList = new List<string> { "fileweed" };
...
"Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/54.0.2840.99 Safari/537.36";
        ...
        private string getSourceDetails(Match episode, String sec, MatchCollection sourceMatches, int i)
        {
            ...
            String sourceResponse = httpPost(standardIceFilmsUrl + "membersonly/components/com_iceplayer/video.phpAjaxResp.php?s="+ sourceMatches[i].Groups[1]+ "&t=" + episode.Groups["vid"], postData, standardIceFilmsUrl + "membersonly/components/com_iceplayer/video.php?h=374&w=631&vid=" + episode.Groups["vid"] + "&img=");
        ...
        private void getSecretSourcesPage(Match episode, out String sourcesPage, out String sec)
        {
            ...
            sourcesPage = httpGet(standardIceFilmsUrl+"membersonly/components/com_iceplayer/video.php?h=374&w=631&vid=" + episode.Groups["vid"] + "&img=", "", "https://icefilms.unblocked.uno/ip.php?v=" + episode.Groups["vid"]);
        ...
        private void edtShowURL_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (this.edtShowURL.Text.Count(x => x == '/') >= 3)
            {
                try
                {
                    var firstpart = this.edtShowURL.Text.Substring(0, this.edtShowURL.Text.IndexOf('/', 8) + 1);
        ...
        {
            this.edtShowURL.Text = standardIceFilmsUrl + "tv/series/8/7434";            //edtShowURL.Text
        }
